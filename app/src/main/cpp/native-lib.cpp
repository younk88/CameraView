...
Java_com_example_kun_cameraview_PreviewActivity_createCamera(JNIEnv *env,
                                                      jobject instance,
...
Java_com_example_kun_cameraview_PreviewActivity_deleteCamera(JNIEnv *env,
                                                      jobject instance,
                                                      jlong ndkCameraObj) {
...
Java_com_example_kun_cameraview_PreviewActivity_getMinimumCompatiblePreviewSize(
...
Java_com_example_kun_cameraview_PreviewActivity_getCameraSensorOrientation(
        JNIEnv *env, jobject instance, jlong ndkCameraObj) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_example_kun_cameraview_PreviewActivity_onPreviewSurfaceCreated(
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_example_kun_cameraview_PreviewActivity_onPreviewSurfaceDestroyed(
        JNIEnv *env, jobject instance, jlong ndkCameraObj, jobject surface) {
    CameraAppEngine *pApp = reinterpret_cast<CameraAppEngine *>(ndkCameraObj);
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_kun_cameraview_PreviewActivity_resizePreview(
        JNIEnv *env, jobject instance, jint transform) {
    if (!pEngineObj) {
        return;
    }
    pEngineObj->resizePreview(transform);
}

extern "C" JNIEXPORT void JNICALL
Java_com_example_kun_cameraview_PreviewActivity_updatePreviewSetting(
        JNIEnv *env, jobject instance, jint hue, jint saturation, jint brightness, jint contract) {
    if (!pEngineObj) {
        return;
    }
    pEngineObj->updatePreviewSetting(hue, saturation, brightness, contract);
}